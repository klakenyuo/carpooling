		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Mail requis">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Mot de passe requis">
						<input class="input100" type="password" name="mot de passe" placeholder="Mot de passe">
						<span class="focus-input100"></span>
					</div>

                    <div class="wrap-input100 validate-input m-b-16" data-validate = "Confirmer le mot de passe">
						<input class="input100" type="password" name="mot de passe" placeholder="Confirmer le mot de passe">
						<span class="focus-input100"></span>
					</div>
			...
			<a href="/"><i class="fa fa-arrow-left"></i> Retour vers Carpooling</a>	
			<a href="/login" style="float:right;">Se Connecter<i class="fa fa-arrow-right"></i></a>	
